...
// Adding enhanced UI tokens for consistency
...
export const transitions = {
  ...
  bounce: 'transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105',
  scale: 'transition duration-300 ease-in-out transform hover:scale-105',
...
export const responsive = {
  ...
  largeDesktopUp: 'hidden xl:block'
};
